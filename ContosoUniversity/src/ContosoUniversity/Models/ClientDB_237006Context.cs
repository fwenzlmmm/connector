...
{
    public partial class ClientDB_237006Context : DbContext
    {
        public ClientDB_237006Context() : base()
        {
        }
        public ClientDB_237006Context(DbContextOptions<ClientDB_237006Context> options) : base(options)
        {
        }
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
            optionsBuilder.UseSqlServer(@"Server=USJNRIDAP01.usac.mmm.com;Database=ClientDB_237006;Trusted_Connection=True;");
        }
        ...
        // Unable to generate entity type for table 'dbo.OutpatientDetails'. Please see the warning messages.
        // Unable to generate entity type for table 'dbo.LvHoldReasons'. Please see the warning messages.
        // Unable to generate entity type for table 'dbo.MappingDataSources'. Please see the warning messages.
        // Unable to generate entity type for table 'dbo.Outpatient'. Please see the warning messages.
        // Unable to generate entity type for table 'dbo.Inpatient'. Please see the warning messages.
        // Unable to generate entity type for table 'dbo.CMClientPayerFlagMap'. Please see the warning messages.
        // Unable to generate entity type for table 'dbo.MappingTableDetails'. Please see the warning messages.
        // Unable to generate entity type for table 'dbo.CMMeasureAbbreviation'. Please see the warning messages.
        // Unable to generate entity type for table 'dbo.MappingTableNames'. Please see the warning messages.
        // Unable to generate entity type for table 'dbo.CMMeasureGroup'. Please see the warning messages.
        // Unable to generate entity type for table 'dbo.CMSubMeasure'. Please see the warning messages.
        // Unable to generate entity type for table 'dbo.CMValidPayerOptions'. Please see the warning messages.
        // Unable to generate entity type for table 'dbo.OutpatientProviders'. Please see the warning messages.
        // Unable to generate entity type for table 'dbo.InpatientProviders'. Please see the warning messages.
        // Unable to generate entity type for table 'dbo.MpOptionModelsGpcsParametersJoe'. Please see the warning messages.
        // Unable to generate entity type for table 'dbo.OutpatientProviders_Load'. Please see the warning messages.
        // Unable to generate entity type for table 'dbo.InpatientProviders_Load'. Please see the warning messages.
        // Unable to generate entity type for table 'dbo.Inpatient_Load'. Please see the warning messages.
        // Unable to generate entity type for table 'dbo.MpSIAGroupToLvFacilities'. Please see the warning messages.
        // Unable to generate entity type for table 'dbo.Outpatient_Load'. Please see the warning messages.
        // Unable to generate entity type for table 'dbo.MpSIAUserToSIAGroups'. Please see the warning messages.
        // Unable to generate entity type for table 'dbo.OutpatientDetails_Load'. Please see the warning messages.
        // Unable to generate entity type for table 'dbo.ParameterDirections'. Please see the warning messages.
        // Unable to generate entity type for table 'dbo.ParameterTypes'. Please see the warning messages.
        // Unable to generate entity type for table 'dbo.PostGrouperData_Canonical'. Please see the warning messages.
        // Unable to generate entity type for table 'dbo.PostGrouperData_CanonicalRecords'. Please see the warning messages.
        // Unable to generate entity type for table 'dbo.PostGrouperData_ErrorBreakdown'. Please see the warning messages.
        // Unable to generate entity type for table 'dbo.PostGrouperData_ErrorData'. Please see the warning messages.
        // Unable to generate entity type for table 'dbo.PostGrouperData_ErrorList'. Please see the warning messages.
        // Unable to generate entity type for table 'dbo.PostGrouperData_ErrorRecords'. Please see the warning messages.
        // Unable to generate entity type for table 'dbo.PostGrouperData_Main'. Please see the warning messages.
        // Unable to generate entity type for table 'dbo.RecordExclusionReasons'. Please see the warning messages.
        // Unable to generate entity type for table 'dbo.ReviewStatuses'. Please see the warning messages.
        // Unable to generate entity type for table 'dbo.SlowMovingTables'. Please see the warning messages.
        // Unable to generate entity type for table 'dbo.States'. Please see the warning messages.
        // Unable to generate entity type for table 'dbo.TargetTable'. Please see the warning messages.
        // Unable to generate entity type for table 'dbo.ValidateHubInputClaimData'. Please see the warning messages.
        // Unable to generate entity type for table 'dbo.ValidateHubInputClaimErrorMap'. Please see the warning messages.
        // Unable to generate entity type for table 'dbo.ValidateHubInputErrorDescription'. Please see the warning messages.
        // Unable to generate entity type for table 'op.LuBillType1st2Digits'. Please see the warning messages.
        // Unable to generate entity type for table 'dbo.ActionPlans'. Please see the warning messages.
        // Unable to generate entity type for table 'op.LuBillType3rdDigits'. Please see the warning messages.
        // Unable to generate entity type for table 'dbo.ActionPlansAttachments'. Please see the warning messages.
        // Unable to generate entity type for table 'dbo.ActionPlansAudit'. Please see the warning messages.
        // Unable to generate entity type for table 'dbo.ActionPlansBookMarks'. Please see the warning messages.
        // Unable to generate entity type for table 'dbo.ActionPlansItems'. Please see the warning messages.
        // Unable to generate entity type for table 'dbo.ActionPlansItemsStatus'. Please see the warning messages.
        // Unable to generate entity type for table 'dbo.ActionPlansMeasuresMapping'. Please see the warning messages.
        // Unable to generate entity type for table 'dbo.ActionPlansProtectedUsers'. Please see the warning messages.
        // Unable to generate entity type for table 'dbo.Bookmarks'. Please see the warning messages.
        // Unable to generate entity type for table 'dbo.BookMarkUsers'. Please see the warning messages.
        // Unable to generate entity type for table 'dbo.CaseAssignments'. Please see the warning messages.
        // Unable to generate entity type for table 'dbo.CaseReviewCCRCMapping'. Please see the warning messages.
        // Unable to generate entity type for table 'dbo.CaseReviews'. Please see the warning messages.
        // Unable to generate entity type for table 'dbo.CMActionPlanLead'. Please see the warning messages.
        // Unable to generate entity type for table 'dbo.CMCaseReviewMeasureMappings'. Please see the warning messages.
        // Unable to generate entity type for table 'dbo.CMCCRC'. Please see the warning messages.
        // Unable to generate entity type for table 'dbo.CMCCRCCategories'. Please see the warning messages.
        // Unable to generate entity type for table 'dbo.CMCCRCCategoriesMapping'. Please see the warning messages.
        // Unable to generate entity type for table 'dbo.MpCareProviderToFacilities'. Please see the warning messages.
        // Unable to generate entity type for table 'dbo.Constants'. Please see the warning messages.
        // Unable to generate entity type for table 'dbo.CMFacilityServiceLocationType'. Please see the warning messages.
        // Unable to generate entity type for table 'dbo.CMGrouperSettings'. Please see the warning messages.
        // Unable to generate entity type for table 'di.Systems'. Please see the warning messages.
        // Unable to generate entity type for table 'dbo.CMMasterLookup'. Please see the warning messages.
        // Unable to generate entity type for table 'di.Enterprises'. Please see the warning messages.
        // Unable to generate entity type for table 'dbo.CMOptionModelTest'. Please see the warning messages.
        // Unable to generate entity type for table 'di.CareProviders'. Please see the warning messages.
        // Unable to generate entity type for table 'di.FacProviders'. Please see the warning messages.
        // Unable to generate entity type for table 'di.Patients'. Please see the warning messages.
        // Unable to generate entity type for table 'dbo.CMSchemaMeasureLookup'. Please see the warning messages.
        // Unable to generate entity type for table 'di.SerLocs'. Please see the warning messages.
        // Unable to generate entity type for table 'dbo.CodeSetFunctionsActionable'. Please see the warning messages.
        // Unable to generate entity type for table 'dbo.CodeSets'. Please see the warning messages.
        // Unable to generate entity type for table 'dbo.CsDiagnosisCodes'. Please see the warning messages.
        // Unable to generate entity type for table 'dbo.CsDiagnosisProcedurePPCCategories'. Please see the warning messages.
        // Unable to generate entity type for table 'dbo.CsDRGs'. Please see the warning messages.
        // Unable to generate entity type for table 'dbo.CsGrouperDischargeStatus'. Please see the warning messages.
        // Unable to generate entity type for table 'dbo.CsGroupers'. Please see the warning messages.
        // Unable to generate entity type for table 'dbo.CsGrouperTypes'. Please see the warning messages.
        // Unable to generate entity type for table 'dbo.CsICDCodeHeaders'. Please see the warning messages.
        // Unable to generate entity type for table 'dbo.CsProcedureCodes'. Please see the warning messages.
        // Unable to generate entity type for table 'dbo.Delete20150918_CMClientPayerFlagMap'. Please see the warning messages.
        // Unable to generate entity type for table 'dbo.Delete20150918_CMPayerMapping'. Please see the warning messages.
        // Unable to generate entity type for table 'dbo.Delete20150918_CMValidPayerOptions'. Please see the warning messages.
        // Unable to generate entity type for table 'dbo.InputTable'. Please see the warning messages.
        // Unable to generate entity type for table 'dbo.LuDischargeStatus837'. Please see the warning messages.
        // Unable to generate entity type for table 'dbo.LuServiceLines'. Please see the warning messages.
        // Unable to generate entity type for table 'dbo.LuServiceLineUses'. Please see the warning messages.
    }
}
